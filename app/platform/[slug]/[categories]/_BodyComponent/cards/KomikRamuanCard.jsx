        ...
        <div className="mt-auto">
          {href ? (
            <Link
              ...
              className="block rounded-lg bg-[#43334C] py-1 text-center text-sm font-semibold text-white transition-colors hover:bg-transparent hover:text-[#43334C] hover:border-2 border-[#43334C] md:mb-1 cursor-pointer"
            >
              {buttonLabel}
            </Link>
          ) : (
            <button
              type="button"
              onClick={handleTrackClick}
              className="block w-full rounded-lg bg-[#43334C] py-1 text-sm font-semibold text-white transition-colors hover:bg-transparent hover:text-[#43334C] hover:border-2 border-[#43334C] mb-1 cursor-pointer"
            >
              {buttonLabel}
            </button>
          )}

...
export default function PermissionPage() {
  ...
  return (
    <PermissionGate
      requiredPermissions={['permissions.read', 'roles.permissions.read', 'permission-groups.read']}
    >
      <div className="p-4 sm:p-6 bg-white border rounded-lg">
        <div className="mb-4 sm:mb-6">
          ...
          <p className="text-xs sm:text-sm text-zinc-600 mt-1">
            Manage permissions and role permissions
          </p>
        </div>
        ...
        <Box sx={{ borderBottom: 1, borderColor: 'divider', mb: 2 }}>
          ...
          >
            <Tab
              ...
              sx={{ minWidth: 'auto', fontSize: { xs: '0.75rem', sm: '0.875rem' } }}
            />
            <Tab
              label="Roles"
              id="tab-1"

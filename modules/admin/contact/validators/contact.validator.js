...
export const contactSchema = z.object({
  ...
  locationAddress: z.string()
    .min(1, { message: "Alamat lokasi wajib diisi" }),
  
  operationalHours: z.string()
    .min(1, { message: "Jam operasional wajib diisi" }),
  ...
  instagramUrl: z.string().url({ message: "URL Instagram tidak valid" }).optional().or(z.literal('')),

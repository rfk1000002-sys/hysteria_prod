	...
	const items = [
		...
		{ categorySlug: 'platform', title: 'Hysteria Artlab', slug: 'hysteria-artlab', url: '/platform/hysteria-artlab', order: 0, parentSlug: null, isIndependent: false },
			...
			{ categorySlug: 'platform', title: 'Workshop', slug: 'workshop', url: '/platform/hysteria-artlab/workshop', order: 2, parentSlug: 'hysteria-artlab', isIndependent: false },
				{ categorySlug: 'platform', title: 'Having Fun Artlab', slug: 'having-fun-artlab', url: '/platform/hysteria-artlab/workshop', order: 0, parentSlug: 'workshop', isIndependent: false },
				{ categorySlug: 'platform', title: 'Peltoe', slug: 'peltoe', url: '/platform/hysteria-artlab/workshop', order: 1, parentSlug: 'workshop', isIndependent: false },
			{ categorySlug: 'platform', title: 'Screening Film', slug: 'screening-film', url: '/platform/hysteria-artlab/screening-film', order: 2, parentSlug: 'hysteria-artlab', isIndependent: false },
				{ categorySlug: 'platform', title: 'Making Artist', slug: 'making-artist', url: '/platform/hysteria-artlab/screening-film', order: 0, parentSlug: 'screening-film', isIndependent: false },
				{ categorySlug: 'platform', title: 'Usil', slug: 'usil', url: '/platform/hysteria-artlab/screening-film', order: 1, parentSlug: 'screening-film', isIndependent: false },

...
module.exports = async function seed() {
  ...
  const items = [
    ...
    },
    {
      ...
      title: 'Ngajak Gitlok',
      slug: 'ngajak-gitlok',
      url: '/program/festival/kampung/gitlok',
      order: 2,
      parentSlug: 'festival-kampung',
    },
    {
    ...
    },
    {
      ...
      title: 'Rilis Fest',
      slug: 'rilis-fest',
      url: '/program/festival/kota/rilis-fest',
      order: 1,
      parentSlug: 'festival-kota',
    },
    {
    ...
    },
    {
      ...
      title: 'Rumah Luka',
      slug: 'rumah-luka',
      url: '/program/festival/biennale/rumah',
      order: 0,
      parentSlug: 'biennale',
    },
    {
    ...
    {
      categorySlug: 'program-hysteria',
      title: 'Sorel di Sekitar',
      slug: 'sorel-di-sekitar',
      url: '/program/podcast/sorel',
      order: 0,
      parentSlug: 'podcast',
    },
    ...
    },
    {
      ...
      title: 'Merchandise',
      slug: 'merchandise',
      url: '/platform/artlab/merchandise',
      order: 0,
